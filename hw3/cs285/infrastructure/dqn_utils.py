...
def create_lander_q_network(ob_dim, num_actions, n_layers=2, n_hidden=64):
    """
        Mohsen's code: get architecture of NN for hyperparameter-tuning
    ...
    """
    network = []
    layers = [ob_dim] + [n_hidden] * n_layers + [num_actions]
