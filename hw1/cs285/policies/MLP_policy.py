...
class MLPPolicy(BasePolicy, nn.Module, metaclass=abc.ABCMeta):
    ...
    def __init__(self,
                 ...
                 learning_rate: Optional[bool] = 1e-4,
                 training: Optional[bool] = True,
                 nn_baseline: Optional[bool] = False,
        ...
        if self.discrete:
            ...
            self.logstd = nn.Parameter(
                torch.zeros(self.ac_dim, dtype=torch.float32, device=ptu.device, requires_grad=True)
            )
...
class MLPPolicySL(MLPPolicy):
    def __init__(self, ac_dim, ob_dim, n_layers, size, **kwargs):
        ...
        self.loss = nn.MSELoss()  # TODO: How about discrete case?
