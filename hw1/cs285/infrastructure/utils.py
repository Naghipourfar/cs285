...
def sample_trajectory(env, policy, max_path_length, render=False):
    ...
    while True:
        ...
        rollout_done = (steps >= max_path_length) or bool(terminated) or bool(truncated)  # HINT: this is either 0 or 1
...
def sample_trajectories(env, policy, min_timesteps_per_batch, max_path_length, render=False):
    ...
    while timesteps_this_batch < min_timesteps_per_batch:
        new_traj, n_steps = sample_trajectory(env, policy, max_path_length, render)
        paths.append(new_traj)
        timesteps_this_batch += n_steps
...
def convert_listofrollouts(paths, concat_reward=True):
    """
